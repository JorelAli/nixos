...
gtk-color-scheme = "bg_color:${color "bg"}\nfg_color:#dcdcdc\nbase_color:${color "bgl"}\ntext_color:#eee8d5\nselected_bg_color:${color "ac"}\nselected_fg_color:#fdf6e3\ntooltip_bg_color:${color "ac"}\ntooltip_fg_color:#fdf6e3\ntitlebar_bg_color:${color "bg"}\ntitlebar_fg_color:#dcdcdc\nmenubar_bg_color:${color "bg"}\nmenubar_fg_color:#dcdcdc\ntoolbar_bg_color:${color "bg"}\ntoolbar_fg_color:#dcdcdc\nmenu_bg_color:${color "bg"}\nmenu_fg_color:#dcdcdc\npanel_bg_color:${color "bg"}\npanel_fg_color:#dcdcdc\nlink_color:#fc6f5d"
