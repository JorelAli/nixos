...
[global]
    ...
    #/run/current-system/sw/share/icons/breeze/status/16/:/run/current-system/sw/share/icons/breeze/devices/16/
...
[konsole_sound]
    summary = "Konsole"
    script = /home/jorel/.config/dunst/notifsoundkonsole.sh
